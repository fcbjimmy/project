    ...
    <section className="w-full min-h-full flex justify-center">
      <div className="flex flex-col  max-w-[23rem] md:max-w-xl mt-10 lg:max-w-3xl text-forestGreen">
        ...
        <div className="mt-8 text-justify font-extrabold text-forestGreen">
          Looking to take a step towards zero-waste living? It can be as simple
          as refusing plastic bags, carrying a reusable bottle with you, and
          making the effort to shop at places that limit the amount of plastic
          packaging you take home. With a number of zero waste stores now dotted
          around the city housing refill stations for pantry staples, washing up
          liquids, plastic-free beauty products and more, it's easier than ever
          to be an eco-conscious shopper in Hong Kong.
        </div>
        <div className="flex flex-col">
          ...
          <div className="flex flex-col">
            ...
            <div className="my-8 text-justify font-bold">
              ...
              Sustainable Development, I wanted to make a project related to my
              studies. So, I believe promoting local Environmental Sustainable
              shops will be a good start and a good way to promote moving to a
              plastic-free lifestyle, as a result, everyone can do their bit to
